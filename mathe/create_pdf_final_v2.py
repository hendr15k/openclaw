...
def create_pdf():
    ...
    # Ensure consistent font before any math/text
    pdf.set_font('Helvetica', '', 11)

    # Helper: reduce fancy Unicode that core fonts don't support
    ...
    pdf.solution_text("Winkel Gerade-Ebene: beta = 90deg - alpha")
    pdf.ln(5)
